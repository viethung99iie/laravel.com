(function ($) {
    ...
    HT.setupProductVariant = () => {
        ...
        if ($(".turnOnVariant").length) {
            $(document).on("click", ".turnOnVariant", function () {
                ...
                if (price == "" || code == "") {
                    alert(
                        "Bạn cần phải nhập giá và mã sản phẩm để sử dụng chức năng này!"
                    );
                    return;
                }

                if (_this.siblings("input:checked").length) {
        ...
        $(document).on("change", ".choose-attribute", function () {
            ...
            if (attributeCatalogueId != 0) {
                ...
                _this
                    ...
                    .siblings(".col-lg-8")
                    .html(
                        '<input type="text" name="attributeCatalogue[' +
    ...
    HT.renderVariantItem = (attributeCatalogue) => {
        ...
        html =
            html +
            '<select name="attributeCatalogue[]" id="" class="choose-attribute setUpSelect2">';
    ...
    HT.productVariant = () => {
        ...
        $(".variant-row").each(function (index, value) {
            ...
            for (var i = 0; i < inputHiddenFields.length; i++) {
                _this
                ...
                _this
                    .find(".td-price")
                    .html(HT.addCommas(variant.price[index]));
