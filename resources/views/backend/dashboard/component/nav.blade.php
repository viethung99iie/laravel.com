            ...
            <li>
                <div class=" uk-flex uk-flex-middle ">
                    @foreach ($language as $val)
                        <a href="{{ route('language.switch', ['id' => $val->id]) }}"
                            class="image img-cover language-item {{ $val->current == 1 ? 'active' : '' }} "><img
                                class="laguange-flag" src="{{ $val->image }}"
                                alt="">
                        </a>
                    @endforeach
                ...
                <ul class="dropdown-menu dropdown-messages">
                    ...
                    <li>
                        <div class="text-center link-block">
                            <a href="mailbox.html">
                                <i class="fa fa-envelope"></i> <strong>Read All
                                    Messages</strong>
                            </a>
                        </div>
                    </li>
                    ...
                    <li>
                        <a href="profile.html">
                            <div>
                                ...
                                Followers
                                <span class="pull-right text-muted small">12
                                    minutes ago</span>
                            </div>
                        </a>
                    </li>
