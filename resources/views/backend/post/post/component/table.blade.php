            ...
            <td>
                <div class="uk-flex uk-flex-middle">
                    ...
                    <div class="main-info">
                        ...
                        <div class="catalogue">
                            <span class="text-danger">Nhóm hiển thị
                            </span>
            ...
            <td class="text-center">
                <div class="ibox-content js-switch-{{ $post->id }}">
                    <input type="checkbox" class="js-switch status"
                        data-model="{{ $config['model'] }}" data-field='publish'
                        data-modelId='{{ $post->id }}'
                        value="{{ $post->publish }}" @checked($post->publish ==
                    2) />
                </div>
            </td>
            <td class="text-center">
                <a href="{{ route('post.edit', ['id' => $post->id]) }}"
                    class="btn btn-success mx-2 d-inline"> <i
