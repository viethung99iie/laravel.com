            ...
            <div class="col-lg-12">
                <div class="form-row">
                    ...
                    <select name="catalogue[]" class="form-control setUpSelect2" id="" multiple>
                        @foreach ($dropDown as $key => $val)
                        <option @if(is_array(old('catalogue[]', ( isset($catalogue) && count($catalogue)) ? $catalogue : []) ) && isset($post->post_catalogue_id) && in_array($key, old('catalogue', (isset($catalogue)) ? $catalogue : []))
                            )
                            selected
