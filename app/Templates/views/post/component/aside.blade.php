            ...
            <div class="col-lg-12">
                <div class="form-row">
                    ...
                    <select multiple name="catalogue[]" class="form-control setUpSelect2" id="">
                        @foreach($dropdown as $key => $val)
                        <option @if(is_array(old('catalogue', ( isset($catalogue) && count($catalogue)) ? $catalogue : []) ) && isset(${module}->{module}_catalogue_id) && $key !== ${module}->{module}_catalogue_id && in_array($key, old('catalogue', (isset($catalogue)) ? $catalogue : []))
                            )
                            selected
